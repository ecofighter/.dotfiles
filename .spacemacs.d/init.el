...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ddskk mmm-mode bison-mode)
...
you should place your code here."
  ...
  (when (require 'skk nil t)
    ...
    (setq skk-jisyo (concat (getenv "HOME") "/.config/ibus-skk/user.dict"))
    (require 'skk-study)
    (require 'skk-hint)
    (require 'context-skk))
